...
def generation_prompt(request: GenerationRequest) -> str:
    ...
    sections.append(
        ...
        "- Answer the query in the form it asks for. If the user asks what\n"
        "  to do, read, focus on, compare, or prioritize, respond as direct\n"
        "  guidance rather than as a tour of the documents\n"
        ...
        "  clearly\n"
        "- Avoid document-provenance filler such as 'the section states',\n"
        "  'the document includes', or 'is identified as' unless that\n"
        "  provenance is itself important to the answer\n"
        "- Prefer concise prose over long catalogues. When several source\n"
        "  items belong to the same category, summarize the category and\n"
        "  mention only the most useful examples\n"
